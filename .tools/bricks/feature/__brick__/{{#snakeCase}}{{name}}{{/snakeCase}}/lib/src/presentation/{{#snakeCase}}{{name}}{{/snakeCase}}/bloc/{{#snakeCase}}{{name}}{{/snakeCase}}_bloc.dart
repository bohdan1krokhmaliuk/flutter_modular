...
class {{#pascalCase}}{{name}}{{/pascalCase}}Bloc extends Bloc<{{#pascalCase}}{{name}}{{/pascalCase}}Event, {{#pascalCase}}{{name}}{{/pascalCase}}State> {
  {{#pascalCase}}{{name}}{{/pascalCase}}Bloc(this._repository) : super({{#pascalCase}}{{name}}{{/pascalCase}}State.initial()) {
    on<{{#pascalCase}}{{name}}{{/pascalCase}}Event>((event, emit) =>
      event.map(load: (_) => _onLoad(emit));
    );
  ...
  final FeatureFlowController<{{#pascalCase}}{{name}}{{/pascalCase}}EntrypointState> _flow;
